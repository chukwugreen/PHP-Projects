...
<li><a href ="2nd.php">second semester </a></li>
...
<br><br>
<P id ="welcome">
WELCOME NWACHUKWU GREEN!!!!<br>CHECK OUT YOUR 200L FIRST SESMESTER RESULT </P>
...
$display ="SELECT * FROM 200levelresult  order by id" ;
