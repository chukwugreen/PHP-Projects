...
<li><a href=" 3001stsemester.php">300 Level</a></li>

</ul>
</li>

<li><a href ="200firstsemester.php">First semester </a></li>
...
<br><br>
<P id ="welcome">
WELCOME NWACHUKWU GREEN!!!!<br>CHECK OUT YOUR 200L SECOND SESMESTER RESULT </P>
...
$display ="SELECT * FROM 300levelresult  order by id" ;
...
while($rows=mysqli_fetch_assoc($result)){
	...
	."</td><td>". $rows["GradePoint"]."</td><td>". $rows["Grades"]."</td></tr>";
}
echo"</table>";
}
else{
